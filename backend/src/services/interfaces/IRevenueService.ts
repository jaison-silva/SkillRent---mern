...
export interface IRevenueService {
    ...
    updateCoupon(id: string, data: Partial<ICoupon>): Promise<ICoupon>;
    ...
    updateMembership(id: string, data: Partial<IMembershipPlan>): Promise<IMembershipPlan>;
    ...
    updateOffer(id: string, data: Partial<IOffer>): Promise<IOffer>;
