...
import { useGetMyJobsQuery } from '../jobApiSlice';
      ...
      {isLoading ? (
        ...
        <>
          <div className="space-y-4">
            {jobs.map((job: any) => (
              <div key={job._id} className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col md:flex-row justify-between items-start md:items-center gap-4 hover:border-blue-100 transition-colors">
                <div className="flex-1">
